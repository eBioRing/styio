...
- 语言语义：`../docs/design/Styio-Language-Design.md` / `../docs/design/Styio-EBNF.md`
- 项目原则与目标：`../docs/specs/PRINCIPLES-AND-OBJECTIVES.md`
- 实现规程：`../docs/specs/AGENT-SPEC.md`
- 文档归档策略：`../docs/specs/DOCUMENTATION-POLICY.md`
- 决策记录：`../docs/adr/`
- 维护执行模板：`../docs/assets/templates/REFACTOR-WORKFLOW-TEMPLATE.md`
