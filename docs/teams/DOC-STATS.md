...
| Frontend | [FRONTEND-RUNBOOK.md](./FRONTEND-RUNBOOK.md) | 2,015 | 8,348 |
...
| Test Quality | [TEST-QUALITY-RUNBOOK.md](./TEST-QUALITY-RUNBOOK.md) | 2,809 | 13,240 |
| **Total** | Team runbooks only | **19,603** | **86,431** |
