...
| Frontend | [FRONTEND-RUNBOOK.md](./FRONTEND-RUNBOOK.md) | 2,138 | 9,014 |
...
| Test Quality | [TEST-QUALITY-RUNBOOK.md](./TEST-QUALITY-RUNBOOK.md) | 2,951 | 14,002 |
| **Total** | Team runbooks only | **19,868** | **87,859** |
