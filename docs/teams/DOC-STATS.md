...
| Frontend | [FRONTEND-RUNBOOK.md](./FRONTEND-RUNBOOK.md) | 2,231 | 9,503 |
...
| Test Quality | [TEST-QUALITY-RUNBOOK.md](./TEST-QUALITY-RUNBOOK.md) | 3,190 | 15,212 |
| **Total** | Team runbooks only | **20,200** | **89,558** |
