...
| Frontend | [FRONTEND-RUNBOOK.md](./FRONTEND-RUNBOOK.md) | 1,875 | 7,560 |
...
| Test Quality | [TEST-QUALITY-RUNBOOK.md](./TEST-QUALITY-RUNBOOK.md) | 2,672 | 12,517 |
| **Total** | Team runbooks only | **19,326** | **84,920** |
