...
| Frontend | [FRONTEND-RUNBOOK.md](./FRONTEND-RUNBOOK.md) | 2,295 | 9,842 |
...
| Test Quality | [TEST-QUALITY-RUNBOOK.md](./TEST-QUALITY-RUNBOOK.md) | 3,265 | 15,571 |
| **Total** | Team runbooks only | **20,339** | **90,256** |
