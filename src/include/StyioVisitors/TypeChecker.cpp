...
void StyioToLLVM::check(LocalPathAST* ast) {
}

void StyioToLLVM::check(RemotePathAST* ast) {
}

void StyioToLLVM::check(WebUrlAST* ast) {
}

void StyioToLLVM::check(DBUrlAST* ast) {
}
...
void StyioToLLVM::check(SideBlockAST* ast) {
}

void StyioToLLVM::check(MainBlockAST* ast) {
