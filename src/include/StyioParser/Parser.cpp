  ...
  if (context->check_drop('(')) {
    do {
      ...
      if (context->check('"')) {
        ...
        resources.push_back(make_unique<FinalBindAST>(std::move(varname),
    ...
    string errmsg = string("@(expr) // Expecting ( after @, but got ") +
...
parse_num_val(shared_ptr<StyioContext> context)
{
  ...
  string errmsg =
    string("parse_num_val() // Unexpected value expression, starting with ") +
    char(context->get_cur_char());
...
parse_size_of(shared_ptr<StyioContext> context)
{
  ...
  if (isalpha(context->get_cur_char()) || context->check('_')) {
    ...
    if (context->check('|')) {
      ...
      string errmsg =
        string("|expr| // SizeOf: Expecting | at the end, but got .:| ") +
        char(context->get_cur_char()) + " |:.";
      throw StyioSyntaxError(errmsg);
    }
  } else {
    string errmsg =
      string("|expr| // SizeOf: Unexpected expression, starting with .:| ") +
      char(context->get_cur_char()) + " |:.";
    throw StyioParseError(errmsg);
  }
  ...
  do {
    if (isalpha(context->get_cur_char()) || context->check('_')) {
      ...
      switch (context->get_cur_char()) {
        ...
        */
        case '"': {
          output = make_unique<ListOpAST>(StyioNodeHint::Access_By_Name,
                                          std::move(theList),
        ...
        */
        case '<': {
          ...
          output = make_unique<ListOpAST>(StyioNodeHint::Get_Reversed,
                                          std::move(theList));
        }
        ...
        case '?': {
          ...
          if (context->check_drop('=')) {
            ...
            output = make_unique<ListOpAST>(StyioNodeHint::Get_Index_By_Value,
                                            std::move(theList),
                                            parse_expr(context));
            ...
            output =
              make_unique<ListOpAST>(StyioNodeHint::Get_Indices_By_Many_Values,
                                     std::move(theList),
                                     parse_iterable(context));
          } else {
            string errmsg = string("Expecting ?= or ?^, but got ") +
                            char(context->get_cur_char());
            throw StyioSyntaxError(errmsg);
          }
        }
        ...
        case '^': {
          ...
          */
          if (context->check_drop("<-")) {
            ...
            output = make_unique<ListOpAST>(StyioNodeHint::Insert_Item_By_Index,
                                            std::move(theList),
                                            std::move(index),
                                            parse_expr(context));
          }
          // list[^index]
            ...
            output = make_unique<ListOpAST>(StyioNodeHint::Access_By_Index,
                                            std::move(theList),
                                            std::move(index));
          }
        }
        ...
        */
          ...
          */
          if (context->check_drop('^')) {
            ...
            if (isdigit(context->get_cur_char())) {
              output =
                make_unique<ListOpAST>(StyioNodeHint::Remove_Item_By_Index,
                                       std::move(theList),
            ...
            switch (context->get_cur_char()) {
              ...
              */
              case '=': {
                ...
                output =
                  make_unique<ListOpAST>(StyioNodeHint::Remove_Item_By_Value,
                                         std::move(theList),
                                         parse_expr(context));
              }
            ...
            output = make_unique<ListOpAST>(StyioNodeHint::Remove_Item_By_Value,
                                            std::move(theList),
                                            parse_expr(context));
          }
        }
        ...
        default: {
          string errmsg = string("Unexpected List[Operation], starts with ") +
                          char(context->get_cur_char());
          throw StyioSyntaxError(errmsg);
        }
...
parse_loop_or_iter(shared_ptr<StyioContext> context,
                   unique_ptr<StyioAST> iterOverIt)
{
  context->drop_all_spaces_comments();
  ...
  if ((iterOverIt->hint()) == StyioNodeHint::Infinite) {
    ...
    return make_unique<IterAST>(std::move(iterOverIt),
  ...
  switch (context->get_cur_char()) {
    ...
    case '+': {
      ...
      if (context->check_drop('=')) {
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Inc_Add,
                                std::move(lhs_ast),
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Bin_Add,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
      }
    };
    ...
    case '-': {
      ...
      if (context->check_drop('=')) {
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Inc_Sub,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Bin_Sub,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
      }
    };
    ...
    case '*': {
      ...
      if (context->check_drop('*')) {
        ...
        // <ID> "**" |--
        output =
          make_unique<BinOpAST>(StyioNodeHint::Bin_Pow,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
      } else if (context->check_drop('=')) {
        context->drop_all_spaces();
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Inc_Mul,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
      ...
      // Bin_Mul := <ID> "*" <EXPR>
        ...
        // <ID> "*" |--
        output =
          make_unique<BinOpAST>(StyioNodeHint::Bin_Mul,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
      }
    };
    ...
    case '/': {
      ...
      if (context->check_drop('=')) {
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Inc_Div,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
        ...
        output =
          make_unique<BinOpAST>(StyioNodeHint::Bin_Div,
                                std::move(lhs_ast),
                                std::move(parse_item_for_binop(context)));
      }
    };
    ...
    case '%': {
      ...
      // <ID> "%" |--
      output = make_unique<BinOpAST>(StyioNodeHint::Bin_Mod,
                                     std::move(lhs_ast),
                                     std::move(parse_item_for_binop(context)));
    };
    ...
    default:
      string errmsg = string("Unexpected BinOp.Operator: `") +
                      char(context->get_cur_char()) + "`.";
      throw StyioSyntaxError(errmsg);
...
parse_cond(shared_ptr<StyioContext> context)
{
  ...
  string errmsg = string("parse_cond() : You should not reach this line!") +
                  char(context->get_cur_char());
  throw StyioParseError(errmsg);
}
...
parse_cond_flow(shared_ptr<StyioContext> context)
{
  ...
  */
    ...
    if (context->check_drop('\\')) {
      ...
      if (context->check_drop('t')) {
        ...
        */
        ...
        if (context->check_drop('\\')) {
          ...
          */
          ...
          return make_unique<CondFlowAST>(StyioNodeHint::CondFlow_Both,
                                          std::move(condition),
                                          std::move(block),
                                          std::move(blockElse));
        } else {
          return make_unique<CondFlowAST>(StyioNodeHint::CondFlow_True,
                                          std::move(condition),
                                          std::move(block));
        }
      } else if (context->check_drop('f')) {
        ...
        */
        ...
        return make_unique<CondFlowAST>(StyioNodeHint::CondFlow_False,
                                        std::move(condition),
                                        std::move(block));
      } else {
        string errmsg = string("parse_cond_flow() // Unexpected character ") +
  ...
  string errmsg = string("parse_cond_flow() // You should not reach the end of "
                         "this function. Char: ") +
                  context->get_cur_char();
  throw StyioParseError(errmsg);
}
      ...
      if (context->check_drop('=')) {
        ...
        if (context->check_drop(':')) {
          if (context->check_drop('=')) {
            ...
            return make_unique<FuncAST>(std::move(name),
                                        std::move(dtype),
...
parse_forward(shared_ptr<StyioContext> context, bool is_func)
{
  ...
  if (is_func) {
    ...
    if (context->check('(')) {
      ...
      string errmsg =
        string("parse_forward() // Expecting ( after #, but got ") +
        char(context->get_cur_char());
      throw StyioSyntaxError(errmsg);
    }
  }
  ...
  */
  switch (context->get_cur_char()) {
      ...
      switch (context->get_cur_char()) {
          ...
          /* #(args) ?= value => then */
            ...
            if (context->check_drop("=>")) {
              ...
              if (has_args) {
                ...
                output = make_unique<ForwardAST>(std::move(extra_check),
                                                 std::move(then));
              }
            } else {
              string errmsg =
                string("parse_forward() // Expecting `=>` after `?= "
                       "value`, but got ") +
                char(context->get_cur_char());
              throw StyioSyntaxError(errmsg);
            }
          ...
          switch (context->get_cur_char()) {
            ...
            default: {
              if (isalpha(context->get_cur_char()) || context->check('_')) {
                ...
                string errmsg =
                  string("parse_forward() // Unexpected collection, "
                         "starting with ") +
                  char(context->get_cur_char());
                throw StyioSyntaxError(errmsg);
              }
        ...
        */
        default:
          ...
          if (has_args) {
            output = make_unique<ForwardAST>(std::move(args),
    ...
    */
    case '=': {
      ...
      if (context->check('{')) {
        if (has_args) {
          output =
            make_unique<ForwardAST>(std::move(args), parse_block(context));
        } else {
        ...
        if (has_args) {
          output =
            make_unique<ForwardAST>(std::move(args), parse_expr(context));
        } else {
    ...
    */
    ...
    default:
      string errmsg = string("parse_forward() // Unexpected character ") +
                      char(context->get_cur_char());
      throw StyioSyntaxError(errmsg);
...
parse_read_file(shared_ptr<StyioContext> context, unique_ptr<IdAST> id_ast)
{
  if (context->check_drop('@')) {
    ...
    if (context->check('"')) {
      ...
      string errmsg = string("Expecting id or string, but got ` ") +
                    char(context->get_cur_char()) + " `";
      throw StyioSyntaxError(errmsg);
    }
  } else {
    string errmsg = string("parse_read_file() // Expecting @ as first character but got ` ") +
                    char(context->get_cur_char()) + " `";
    throw StyioSyntaxError(errmsg);
  }
}
...
parse_stmt(shared_ptr<StyioContext> context)
{
  ...
  if (isalpha(context->get_cur_char()) || context->check('_')) {
    ...
    switch (context->get_cur_char()) {
      case '=': {
        ...
        return make_unique<FlexBindAST>(std::move(id_ast),
      ...
      case ':': {
        ...
        if (context->check_drop('=')) {
          ...
          return make_unique<FinalBindAST>(std::move(id_ast),
                                           std::move(parse_expr(context)));
        } else {
          context->drop_white_spaces();
          ...
          if (context->check_drop(':')) {
            ...
            string errmsg =
              string("parse_stmt() // Expecting = or := after type, but got ") +
              context->get_cur_char();
            throw StyioSyntaxError(errmsg);
          }
        }
      ...
      case '<': {
        ...
        if (context->check_drop('-')) {
          ...
          string errmsg = string("Expecting `-` after `<`, but found `") +
                          char(context->get_cur_char()) + "`.";
          throw StyioSyntaxError(errmsg);
        }
      }
  ...
  switch (context->get_cur_char()) {
    ...
    case '@': {
      ...
      if (context->check_drop("->")) {
        ...
        return make_unique<FromToAST>(std::move(resources),
                                      parse_block(context));
      } else {
        return resources;
      }
  ...
  string errmsg = string("Unrecognized statement, starting with `") +
                  char(context->get_cur_char()) + "`";
  throw StyioSyntaxError(errmsg);
}
...
parse_ext_elem(shared_ptr<StyioContext> context)
{
  ...
  if (context->check('\"')) {
    ...
    while (context->get_cur_char() != '\"') {
      if (context->check(',')) {
        string errmsg = string("An \" was expected after") + itemStr +
                        "however, a delimeter `,` was detected. ";
        throw StyioSyntaxError(errmsg);
      }
    ...
    string errmsg =
      string("Dependencies should be wrapped with double quote like "
